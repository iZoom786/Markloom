...
// FIX: Updated AlertTriangleIcon to accept a `title` prop and render it as an SVG <title> element for tooltips and accessibility. This resolves a type error in Materials.tsx.
export const AlertTriangleIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ title, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const WarehouseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M22 12H18V8l-4-4-4 4v4H2"></path>
        <path d="M22 12v8H2v-8"></path>
