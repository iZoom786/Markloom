                    ...
                    <ul className="space-y-2">
                        {workOrders.length > 0 ? (
                            workOrders.slice(0, 5).map(wo => {
                                ...
                                return (
                                    <li key={wo.woNumber} className="flex justify-between items-center text-sm p-2 bg-gray-50 rounded-md">
                            ...
                            <li className="text-sm text-gray-500 p-2">No recent work orders found.</li>
                        )}
                    </ul>
                </Card>
                <Card>
                     ...
                     <ul className="space-y-2">
                        {pendingPOs.length > 0 ? (
                            pendingPOs.slice(0, 5).map(po => (
                                <li key={po.poNumber} className="flex justify-between items-center text-sm p-2 bg-gray-50 rounded-md">
                             ...
                             <li className="text-sm text-gray-500 p-2">No pending deliveries.</li>
                        )}
                    </ul>
                </Card>
            </div>
